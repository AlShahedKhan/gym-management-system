...
<?php $__env->startSection('title'); ?>
    <?php echo e(@$data['title'] ?? 'Edit Booking'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="bradecrumb-title mb-1"><?php echo e($data['title'] ?? 'Edit Booking'); ?></h4>
                    <ol class="breadcrumb">
        ...
        <div class="card ot-card">
            <div class="card-header">
                <h4><?php echo e(___('common.edit')); ?> Booking</h4>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" name="trainee_id" id="trainee_id" required>
                                ...
                                <?php $__currentLoopData = $trainees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($trainee->id); ?>" <?php echo e($trainee->id == $booking->trainee_id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="class_id" id="class_id" required>
                                ...
                                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($class->id); ?>" <?php echo e($class->id == $booking->class_id ? 'selected' : ''); ?>>
                                        <?php echo e($class->class_time); ?> (<?php echo e($class->trainer->user->name); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(\Carbon\Carbon::parse($booking->booking_time)->format('Y-m-d\TH:i')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 mt-24 text-end">
                        <button class="btn btn-lg ot-btn-primary">
                            <span><i class="fa-solid fa-save"></i></span> <?php echo e(___('common.update')); ?>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-stater-kits\resources\views/bookings/edit.blade.php ENDPATH**/ ?>